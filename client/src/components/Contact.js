  ...
  render() {
    return(
      <form id="contact" className="contact-form" onSubmit={ (e) => this.formSubmit(e)}>
        ...
        <input autoComplete="none" onChange={ e => this.setState({ name: e.target.value })} name="name" className="message-name" type="text" placeholder="Your Name" required value={this.state.name}/>

        <label className="message-email" htmlFor="message-email">Your Email</label>
        <input autoComplete="on" onChange={ (e) => this.setState({ email: e.target.value })} name="email" className="message-email" type="email" placeholder="your@email.com" required value={this.state.email} />

        <label className="message-subject" htmlFor="message-subject">Your Subject</label>
        <input autoComplete="none" onChange={ e => this.setState({ subject: e.target.value })} name="subject" className="message-name" type="text" placeholder="Subject" required value={this.state.subject}/>
